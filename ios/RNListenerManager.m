...
{
    return [NativeNotificationManager shareNotification].ListenerNameArr;;
}
// 开启通知
-(void)startObserving {
    NSString *notifiName = [NativeNotificationManager shareNotification].CurrentListenerName;
...
-(void)stopObserving
{
    NSString *notifiName = [NativeNotificationManager shareNotification].CurrentRemoveListenerName;
